...
module global_input_parameters
  ...
  !To adjust Strength of the large-scale B when computing observables
  double precision :: fB = 1.0 !#CJ fB=1.0 default. Not in R19
  ! RANDOM MAGNETIC FIELD
  !Strength of the rms random magnetic field brms in units of Beq
  double precision :: fmag = 0.5 !#CJ fmag = 0.5d0 in R19 
  ! To set fmag a constant for all galaxies or not. If it is set to .false. manually put a model in LoS_integrate_aux.f90
  logical :: set_fmag_constant = .true. !#CJ = .true.  in R19/J24 
  !     DIFFUSIVE MAGNETIC HELICITY FLUX
  !Ratio kappa_t/eta_t of turbulent diffusivities of alpha_m and B
  double precision :: R_kappa = 0.3
  ! in R19 R_kappa = 1.0d0 CJ
  
  double precision :: fBeq = 1.0 ! added by CJ. Default value 0.5
        ! Relates energy densities of turbulance and equipartition field. 
        ! defined by Eq. 11 of Luiz 18. Used by profiles.f90
        ! probably degenerate with fmag
  ...
  namelist /dynamo_parameters/ &
    ...
    fmag, set_fmag_constant, R_kappa, fBeq, fB
  ...
  ! -------------------------------------------------------
  ! Sound speed (in km/s)
  double precision :: p_ISM_sound_speed_km_s = 25d0 !#CJ p_ISM_sound_speed_km_s= 10d0. This param is no longer used
  ...
  ! Below param added by CJ.This is the fraction of molecular gas without Dynamo. Default value 1 as in R19 and J24 
  double precision :: frac_mol_without_dyn =0.5!0.0d0!added by SG! 0.5
  ...
  integer :: correct_SFR_offset = 1  !CJ edit
 ...
 ! Initially this factor is set to 1; will be read from a file if SFR_offset_correction = 1  
  ...
  character (len=80) :: SFR_offset_file_name = &
      ...
      '/scratch/ccharles/galform_output/Lacey14_SFRcor_offset_HB06.txt' !HB06 after correcting for SFR
...
!      '/scratch/ccharles/galform_output/Lacey14_SFR_offset_HB06.txt' !HB06
  double precision :: SFR_th = 3.0 !added by CJ. Used in CJ et. al. 2023 RLF paper 
