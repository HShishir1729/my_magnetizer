...
!Bulk qtys
    ...
    call IO_read_dataset_scalar('Mstars_bulge', gal_id, bufferz, group='Input')
    props%Mstars_bulge = bufferz
    call IO_read_dataset_scalar('Mhalo', gal_id, bufferz, group='Input')
    props%Mhalo = bufferz
    call IO_read_dataset_scalar('r_disk', gal_id, bufferz, group='Input')
    props%r_disk = bufferz
    call IO_read_dataset_scalar('SFR', gal_id, bufferz, group='Input')
    props%SFR = bufferz
    call IO_read_dataset_vector('Beq', gal_id, buffer, group='Output') 
    props%Beq = buffer
