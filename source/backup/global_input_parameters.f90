...
module global_input_parameters
  ...
  double precision :: C_alp = 0.9d0  !CJ edit. C_alp=1.0d0
  ! FLOOR
  ...
  double precision :: fmag = 0.5d0 !#CJ fmag = 0.5d0
  ...
  ! -------------------------------------------------------
  ! Sound speed (in km/s)
  double precision :: p_ISM_sound_speed_km_s = 30d0 !#CJ p_ISM_sound_speed_km_s= 10d0
